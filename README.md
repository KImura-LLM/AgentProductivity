...
Бот также понимает часть естественных фраз: `что мне делать сегодня`, `покажи задачи на неделю`, `что зависло`, `личные задачи`, `лег спать в 23:25`, `проснулся в 07:40`, `картинка графика сна`, `главный фокус выполнен`.
